...
<!-- TODO: replace with actual image — 원본 hero image (Google Gemini 3 Pro를 이용하여 직접 생성) -->
...
<!-- TODO: replace with actual image — 사진 1: Pulumi 로고 -->
...
<!-- TODO: replace with actual image — 사진 2: 코드-상태-리소스의 관계 (Google Gemini 3 Pro를 이용하여 직접 생성) -->
...
<!-- TODO: replace with actual image — 사진 3: Claude Code 로고 -->
...
<!-- TODO: replace with actual image — 사진 4: Drift 해결 워크플로우 플로우차트 (Google Gemini 3 Pro를 이용하여 직접 생성) -->
...
<!-- TODO: replace with actual image — 사진 5: Agent가 ignoreChanges를 무분별하게 추가한 모습 -->
...
<!-- TODO: replace with actual image — 사진 6: Before — 수십 개의 Drift가 표시된 preview 결과 (여러 스택 중 하나의 예시) -->
...
<!-- TODO: replace with actual image — 사진 7: After — 업데이트 할 것이 없다고 표시된 preview 결과 (동일 스택) -->
...
<!-- TODO: replace with actual image — 사진 8: 사내에서 진행한 세미나 -->
